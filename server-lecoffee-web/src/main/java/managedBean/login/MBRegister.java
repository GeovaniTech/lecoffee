...
public class MBRegister extends AbstractMBean {
	...
	public void sendConfirmationTokenEmail(String email) {
		...
		description.append("<h2>Confirme o seu cadastro no LeCoffee</h2>");
		description.append("<p>Olá,	</p>");
		description.append("<p>Agradecemos por se cadastrar no LeCoffee! ");
		...
		description.append("<p>Caso você não tenha criado uma conta no LeCoffee ");
